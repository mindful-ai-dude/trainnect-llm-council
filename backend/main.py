...
class SendMessageRequest(BaseModel):
    ...
    file_content: Optional[str] = None  # Parsed file content
...
async def send_message_stream(conversation_id: str, body: SendMessageRequest, request: Request):
    ...
    async def event_generator():
        try:
            ...
            # Add user message (original content without file for storage)
            ...
            # Store file metadata for later stages if file was uploaded
            file_metadata = {}
            if body.file_name:
                file_metadata = {
            ...
            if body.execution_mode in ["chat_ranking", "full"]:
                ...
                async for item in stage2_collect_rankings(user_content, stage1_results, search_context, request):
            ...
            if body.execution_mode == "full":
                ...
                stage3_result = await stage3_synthesize_final(user_content, stage1_results, stage2_results, search_context)
            ...
            # Include file metadata if file was uploaded
            if file_metadata:
